...
export default function Banner() {
  ...
  useEffect(() => {
    const getSliderMovie = async () => {
      try {
        const res = await axios.get("https://playvergrserver2-1.onrender.com/api/movie/randomMovie", {
          headers: {
            Authorization:
  ...
  const imageSlider = content?.poster;
                  ...
                  <Col xl="7" lg="12" md="12">
                    ...
                    >
                      ...
                      <div className="text-primary title starring">
                        Director:{" "}
                        <span className="text-body">{content?.directors}</span>
                      </div>
                      {/* Cast */}
                      ...
                      <div className="text-primary title tag">
                        Genres: <span className="text-body">{content?.genres}</span>
                      </div>
                    </div>
                  </Col>
                  {/* Right Side */}
